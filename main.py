...
def run_once():
    ...
    if once == 0:
        button23["text"] = "x"
        button23.configure(image=image4)
        button32["text"] = "x"
        button32.configure(image=image4)
        button45["text"] = "x"
...
def set_text2b(b):
    ...
    if(eval(b)['text'] == 'x'):
        ...
        for i in range(len(array)):
            ...
            if array_button[i]["text"] == "○":
                array_button[i].configure(image=image2)
            elif array_button[i]["text"] == "●":
                array_button[i].configure(image=image1)
            elif array_button[i]['text'] == "":
                array_button[i].configure(image=image3)
            else:
                array_button[i].configure(image=image4)
        a = 0
        for i in kiban():
            if i == "x":
                a = a + 1
...
if __name__ == '__main__':
    ...
    image1 = PhotoImage(file = 'black.png')
    image2 = PhotoImage(file = 'white.png')
    image3 = PhotoImage(file = 'green.png')
    image4 = PhotoImage(file = 'orange.png')
